...
const bs58 = require("bs58");  // ✅ Add this to decode Base58
...
const BEAST_MEME_TOKEN_MINT = new PublicKey(process.env.TOKEN_ADDRESS); // 🔹 Load Token Mint from .env
const EXCHANGE_RATE = 100000000; // 1 SOL = 100,000,000 BEAST MEME
const MIN_PURCHASE_SOL = 0.1; // 🔹 Minimum 0.1 SOL purchase

// 🔹 Convert Base58 SOL_WALLET (string) to Uint8Array
const sellerKeypair = Keypair.fromSecretKey(bs58.decode(process.env.SOL_WALLET));
